...
bool BGPStateActive :: onEvent(Event event){
    ...
    {
    case ManualStop:
        if(stateMachine->delayOpenTimer->isRunning() && stateMachine->getDampPeerOscillations()){
    ...
    case ConnectRetryTimer_Expires:
        ...
        // TODO continues to listen for a TCP connection that may be initiated
    ...
    case TcpConnection_Valid:
        // TODO the local system processes the TCP connection flags and stays
        // in the Active state.
        break;
    case Tcp_CR_Invalid:
