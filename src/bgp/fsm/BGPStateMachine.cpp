...
void BGPStateMachine ::resetConnectRetryTimer() {
    ...
    connectRetryTimer = new Timer(
        "ConnectRetryTimer", ConnectRetryTimer_Expires, this, connectRetryTime);
}
...
void BGPStateMachine ::resetKeepAliveTimer() {
    ...
    keepAliveTimer = new Timer(
        "KeepAliveTimer", KeepaliveTimer_Expires, this, keepaliveTime);
}
...
void BGPStateMachine ::resetDelayOpenTimer() {
    ...
    delayOpenTimer = new Timer(
        "DelayOpenTimer", DelayOpenTimer_Expires, this, delayOpenTime);
}
